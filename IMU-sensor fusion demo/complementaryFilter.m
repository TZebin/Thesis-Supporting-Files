...
[numBack,txtBack,rawBack] = xlsread(filename,1);
% [numRightThigh,txtRightThigh,rawRightThigh] = xlsread(filename,2);
% [numLeftThigh,txtLeftThigh,rawLeftThigh] = xlsread(filename,3);
% [numRightShank,txtRightShank,rawRightShank] = xlsread(filename,4);
% [numLeftShank,txtLeftShank,rawLeftShank] = xlsread(filename,5);
