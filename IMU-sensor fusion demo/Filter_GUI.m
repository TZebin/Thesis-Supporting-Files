...
function Filter_GUI
    h = figure('Position',[50,100,800,900]);
    uicontrol(...
        'Style','pushbutton',...
        'String','Select File to Analyze',...
        'Position',[10,250,200,25],...
    ...
    uicontrol(...
        ...
        'Position',[10,215,200,25],...
        'HorizontalAlignment','Center');
    hHPF = uicontrol(...
        'Style','edit',...
        'String','0.98',...
        'Position',[10,200,200,25]);
    uicontrol(...
        'Style','text',...
        'String','Low Pass Filter Constant:',...
        'Position',[10,165,200,25],...
        'HorizontalAlignment','Center');
    hLPF = uicontrol(...
        'Style','edit',...
        'String','0.02',...
        'Position',[10,150,200,25]);
    
    % GUI Output
    htheta1 = axes(...
        'Units','Pixels',...
        'Position',[270,650,400,250]);
    htheta2 = axes(...
        'Units','Pixels',...
        'Position',[270,350,400,250]);
    htheta3 = axes(...
        'Units','Pixels',...
        'Position',[850,350,400,250]);
    htheta4 = axes(...
        'Units','Pixels',...
        'Position',[270,50,400,250]);
    htheta5 = axes(...
        'Units','Pixels',...
    ...
    function Analyze(~,~)
        ...
        for s = 1:numSheets
            ...
            plot(plocZ,pksZ,'x')
            plot(vlocZ,-valZ,'o')
            title(sheetNames{s},'FontName','Times New Roman' )
            xlabel('Time (s)','FontName','Times New Roman')
            ylabel('Angle (radians)','FontName','Times New Roman')
            legend([x,y,z],{'thetaX','thetaY','thetaZ'},'Location','southeast',...
